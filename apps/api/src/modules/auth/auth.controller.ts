...
import { BasicAuthEnum, SocialAuthEnum, SwaggerOperationEnum } from '@/shared/enums';
...
export class AuthController {
  ...
  async loginAsAdminWithGoogle(@Body() dto: CreateUserBySocialDto) {
    const authService = this.authFactory.getSocialAuthService(SocialAuthEnum.GOOGLE);
