...
@Injectable()
export class UserJwtRefreshTokenStrategy extends PassportStrategy(Strategy, 'user-jwt-refresh-token') {
  constructor(
    ...
    super({
      ...
      secretOrKey: configService.get<UserAuthConfig>('userAuth').refreshTokenSecret,
    });
  }
