...
export class BasicAuthService {
  ...
  async createUser(dto: CreateUserByPasswordDto): Promise<{ user: User; tokens: TokensType }> {
  ...
  async validateUser(dto: ValidateUserByPasswordDto): Promise<{ user: User; tokens: TokensType }> {
    const { wallet } = dto;
  ...
  async loginByWallet(dto: CreateWalletDto): Promise<{ user: User; tokens: TokensType }> {
    const { wallet } = dto;
